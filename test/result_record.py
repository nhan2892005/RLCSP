...
class Result:
    def __init__(self, policy, name:str, observation, count):
        self.list_result = []
        self.policy = policy
    ...
    def add_result(self, observation):
        ...
        num_stock_used = self._get_num_stock_not_empty(observation["stocks"])
        ...
        self.list_result.append((num_stock_used, num_empty, prods_remain))
